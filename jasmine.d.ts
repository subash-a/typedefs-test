// Modification of https://github.com/borisyankov/DefinitelyTyped/blob/ff104ed7cc13a3eb2e89f46242c4dbdbbe66665e/jasmine/jasmine.d.ts
/* tslint:disable */
...
declare module jasmine {
	...
	interface Matchers {
		...
		Any: Any;
		/* Custom Matchers for Modelogiq Frontend */
		is(expected: any, expectationFailOutput?: any): boolean;
		toHaveThrown(expected: Error): boolean;
		toBeUndefinedOrEmpty(): boolean;
		toArrayValsBe(v: ArrayLike<Object>): boolean;
		toBePairRow(v: [any, any]): boolean;
		toSerializeEqual(v: ProtobufClass): boolean;
		/* End of Custom Matchers for Modelogiq Frontend */
	}
