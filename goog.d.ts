// Uses https://github.com/teppeis/closure-library.d.ts/tree/master/closure/goog as a base
/* tslint:disable */
declare module goog {
	module crypt {
		module base64 {
			/**
				...
				* @type {string}
				*/
			const ENCODED_VALS_BASE: string;

			/**
				* Our default alphabet. Value 64 (=) is special; it means "nothing."
				* @type {string}
				*/
			const ENCODED_VALS: string;

			/**
				* Our websafe alphabet.
				* @type {string}
				*/
			const ENCODED_VALS_WEBSAFE: string;
			...
			/**
				...
				* @type {boolean}
				*/
			const HAS_NATIVE_SUPPORT: boolean;
